...
def get_parser():  # type: () -> argparse.ArgumentParser
    ...
    parser.add_argument('--make', '-m', help='Command to run make', type=str, default='make')

    parser.add_argument('--encrypted', help='Use encrypted targets while running make', action='store_true')
    ...
    parser.add_argument(
        'elf_files',
        help='ELF files of application, bootloader, etc. '
    ...
    parser.add_argument('--revision', help='Revision of the target', type=int, default=0)
    ...
    parser.add_argument('--timestamps', help='Add timestamp for each line', default=False, action='store_true')
    ...
    parser.add_argument(
        '--open-port-attempts',
        help='Number of attempts to wait for the port to appear (useful if the device is not connected or in deep '
